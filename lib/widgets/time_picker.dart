...
/// See also:
///
/// * [showTimePicker], a function that shows a [TimePickerWidget] and returns
...
/// [Navigator.pop].
///
/// Use [showTimePicker] to show a dialog already containing a [TimePickerWidget].
class TimePickerWidget extends StatefulWidget {
  ...
  /// Restoration ID to save and restore the state of the [TimePickerWidget].
  ///
...
Future<TimeOfDay?> showTimePicker({
  ...
  final Widget dialog = TimePickerWidget(
